    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_buy_privilege', models.DateField(default=datetime.datetime(2023, 5, 17, 11, 53, 22, 607185, tzinfo=utc), verbose_name='Дата покупки привилегии')),
                ('time_buy_profile_sub', models.DateField(default=datetime.datetime(2023, 5, 17, 11, 53, 22, 607185, tzinfo=utc), verbose_name='Дата покупки фона профиля')),
                ('time_buy_market_privilege', models.DateField(default=datetime.datetime(2023, 5, 17, 11, 53, 22, 607185, tzinfo=utc), verbose_name='Дата покупки доступа к маркету')),
