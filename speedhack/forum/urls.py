...
urlpatterns = [
    ...
    path('forum/admin-panel/tickets/', views.tickets, name='tickets'),
    path('forum/admin-panel/ticket/<int:ticket_id>/close/', views.ticket_close, name='ticket_close'),
    path('forum/admin-panel/ticket/<int:ticket_id>/open/', views.ticket_open, name='ticket_open'),
    path('forum/ticket/<int:ticket_id>/', views.ticket, name='ticket'),
    path('forum/ticket/<int:ticket_id>/comment/', views.add_answer, name='add_answer'),
